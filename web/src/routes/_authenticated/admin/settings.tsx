      ...
      <div className="grid gap-10 md:grid-cols-[220px_minmax(0,1fr)]">
        ...
        <div className="flex min-w-0 flex-col gap-10">
          ...
          <SettingsSection
            ...
            title="Ask (LLM)"
            icon={Sparkles}
            description="Answer-generation providers powering the Ask tab. Mix Anthropic + OpenAI + local Ollama; per-message picker shows the allowlisted models."
          >
            <LLMForm />
          </SettingsSection>
...
// ModelCombobox is shared at @/components/ui/model-combobox — both the
// embedding form (above) and the LLM admin form (added in Phase 1 of the
// RAG feature) import it from there. The legacy local copy was removed.
