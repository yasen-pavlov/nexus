...
// User shape. The auth endpoints (login, register, /me) and the admin
// /api/users list all return userResponse — created_at is now populated
// from the DB on every path (Phase 5 wired Me() through GetUserByID).
